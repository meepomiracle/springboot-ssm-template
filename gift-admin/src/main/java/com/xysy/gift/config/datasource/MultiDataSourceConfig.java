package com.xysy.gift.config.datasource;

import com.alibaba.druid.pool.DruidDataSource;
import com.baomidou.mybatisplus.plugins.OptimisticLockerInterceptor;
import com.baomidou.mybatisplus.plugins.PaginationInterceptor;
import com.xysy.gift.core.config.properties.DruidProperties;
import com.xysy.gift.core.config.properties.MutiDataSourceProperties;
import com.xysy.gift.core.datascope.DataScopeInterceptor;
import com.xysy.gift.core.mutidatasource.DynamicDataSource;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "gift.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2)
@MapperScan(basePackages = {"com.xysy.gift.modular.*.dao","com.xysy.gift.multi.mapper"})
public class MultiDataSourceConfig {

    @Bean
    @ConfigurationProperties(prefix = "gift.muti-datasource")
