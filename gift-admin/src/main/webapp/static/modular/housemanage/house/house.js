...
House.initColumn = function () {
    return [
        {field: 'selectItem', radio: true},
            {title: '房屋ID', field: 'id', visible: true, align: 'center', valign: 'middle'},
            {title: '房屋名字', field: 'name', visible: true, align: 'center', valign: 'middle'},
            {title: '房屋描述', field: 'desc', visible: true, align: 'center', valign: 'middle'},
            {title: '房屋价格', field: 'price', visible: true, align: 'center', valign: 'middle'},
