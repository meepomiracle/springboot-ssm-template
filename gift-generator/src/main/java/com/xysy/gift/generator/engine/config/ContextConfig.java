package com.xysy.gift.generator.engine.config;
...
public class ContextConfig {
    ...
    private String projectPath = "D:\\ideaSpace\\gift";//模板输出的项目目录
    ...
    private String proPackage = "com.xysy.gift.admin";
    private String coreBasePackage = "com.xysy.gift.core";
    private String modelPackageName = "com.xysy.gift.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.xysy.gift.modular.system.dao";    //model的dao
